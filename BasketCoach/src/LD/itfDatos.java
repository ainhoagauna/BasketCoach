...
public interface itfDatos  
{
	...
	/**
	 * 
	 *  fichero: enumerado de la clase clsConstantes que indica el fichero del que se
	 * 					va a leer. 
	 ...
	 */
	public void ComenzarRead(MiEnumerado fichero) throws IOException;
	/**
	...
	/**
	 * 
	 * @return ArrayList : Devuelve un arraylist con los datos leídos, en el tipo
	 * Serializable.
	 */
